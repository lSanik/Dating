...
<div class="left-nav">
    ...
    @else
        <ul class="nav">
            ...
            <li><a href="/{{ App::getLocale() }}/profile/{{ Auth::user()->id }}/photo/">{{ trans('profile.photo') }}</a>
            </li>
            <li><a href="/{{ App::getLocale() }}/profile/{{ Auth::user()->id }}/video/">{{ trans('profile.video') }}</a>
            </li>
    ...
    <div class="container-fluid">
        <div class="row top_nav">
            ...
            <div class="col-md-4 col-xs-5">
                ...
                @else
                    <span class="top_nav_mnu_right"><a href="#" class="coin_btn"><i class="fa fa-btc"
                                                                                    aria-hidden="true"></i>25 Coins</a> <a
                                class="cart" href="#">Cart</a></span>
                @endif
            </div>
        </div>
                    ...
                    <div class="modalContent col-md-12">
                        ...
                        <form action="/login" method="post" class="form form-inline">
                            ...
                            <div class="col-md-12" style="margin-top: 10px">
                                ...
                                <button type="submit" class="btn btn-sm btn-default"><i class="fa fa-unlock"></i> Sign
                                    In
                                </button>
                                <div class="col-md-12">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <div class="modalContent col-md-12">
                        ...
                        <div class="form-group col-md-6">
                            <button class="btn btn-pink btn-sm" type="submit" id="createAccount"><i
                                        class="fa fa-heart"></i> CREATE ACCOUNT
                            </button>
                        </div>
                        <div class="col-md-12">
